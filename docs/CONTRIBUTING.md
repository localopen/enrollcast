...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("localopen/enrollcast", fork = TRUE)`.
...
Please note that the enrollcast project is released with a [Contributor
Code of
Conduct](https://github.com/localopen/enrollcast/CODE_OF_CONDUCT.md). By
