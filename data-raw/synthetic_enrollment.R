# Generate synthetic district enrollment data for the enrollcast package.
#
...
# the data is internally consistent with the method enrollcast implements.
...
rows <- do.call(
	rbind,
	lapply(names(base), function(sector) {
